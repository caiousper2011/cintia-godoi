...
export default function Home() {
  return (
    <>
      <h1 className="text-3xl text-zinc-900">Settings</h1>
      <SettingsTabs />
        ...
        >
          <div className="grid-cols-form grid gap-3">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <Input.Root>
                <Input.Control defaultValue="Barbosa" />
              </Input.Root>
            </div>
          </div>
          ...
          <div className="grid-cols-form grid gap-3 pt-5">
            ...
            <Input.Root>
              <Input.Prefix>
                <Mail className="w-5h-5 text-zinc-500" />
              </Input.Prefix>
              <Input.Control
                id="email"
                type="email"
                defaultValue="caiousper2011@hotmail.com"
              />
            </Input.Root>
          </div>
